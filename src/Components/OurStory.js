  ...
  return (
    <React.Fragment>
      ...
      <button
        ...
        class="py-2 border-solid border-2 px-6 rounded-full border-whiteText text-whiteText hover:text-darkGreen hover:bg-whiteText hover:font-bold transition-all"
      >
        Our Story
      </button>
      <Modal
